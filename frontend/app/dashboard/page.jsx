        ...
        <div className="flex flex-col gap-[3.89vw] items-start self-stretch shrink-0 flex-nowrap relative">
          ...
          <div className="flex flex-col gap-[1.67vw] items-start self-stretch">
            ...
            max-md:w-[95vw] max-md:h-[37.6vw] max-md:rounded-[3.2vw] max-md:px-[3.2vw] max-md:py-[2.267vw] max-md:gap-[0.533vw]">
              <div className="flex gap-[1.11vw] items-start text-[1.04vw] font-[460] text-[rgba(255,255,255,0.6)] uppercase max-md:hidden">
              ...
              {getFilteredTeam().map((team, index) => (
                <div key={index} className="flex gap-[1.11vw] items-center text-[1.32vw] font-[450] text-white max-md:flex-col max-md:bg-[#004c56] max-md:rounded-[1.5vw] max-md:p-[2vw] max-md:mb-[2vw]">
                  <span className="flex-1 max-md:text-[4vw] max-md:font-bold">{team.fullname}</span>
                  <span className="flex-1 max-md:text-[3.5vw]">{team.district}</span>
                  <span className="flex-1 max-md:text-[3.5vw]">{team.role}</span>
                  <span className="flex-1 max-md:text-[3.5vw]">{team.order_count}</span>
                  <span className="flex-1 max-md:text-[3.5vw]">{team.role === 'confectioner' ? team.average_crafting_time : team.average_delivery_time}</span>
                  <div className="cursor-pointer w-[3.06vw] h-[3.06vw] p-[0.76vw] bg-[url(/images/IconWrapper3.svg)] bg-cover rounded-[0.56vw] border border-[rgba(255,255,255,0.12)] max-md:hidden" />
                </div>
              ))}
            </div>
