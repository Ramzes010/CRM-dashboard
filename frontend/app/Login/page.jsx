    ...
    <div className="main-container bg-[#e6ebce] mx-auto w-full overflow-hidden">
      ...
      <rect width="36" height="36" fill="white" transform="translate(0.5)"/>
        ...
        <div className=" max-w-[30.556vw] mx-auto max-md:max-w-[100vw]">
          <h1 className="text-[4.083vw] text-white text-center font-light mb-[0.556vw] max-md:text-[8.533vw] max-md:mb-[8.533vw] max-md:text-center ">
            Welcome
          </h1>
          ...
          <div className="border border-[#1f535c] rounded-[0.833vw] max-md:rounded-[3.2vw]">
            {/* Phone Input */}
            <div className="p-[1.389vw] border-b border-[#1f535c] max-md:pt-[4vw] max-md:pl-[6.4vw] max-md:pb-[2.133vw] ">  {/* Исправлено с 0.417vw на 1.389vw (20px) */}
            ...
            {/* Password Input */}
            <div className="p-[1.389vw] flex justify-between items-center">  {/* Исправлено с 0.417vw на 1.389vw (20px) */}
          ...
          {/* Buttons */}
          <div className="mt-[1.389vw] space-y-[0.833vw] max-md:mt-[6.4vw]"> {/* Исправлено на 1.389vw (20px) и 0.833vw (12px) */}
            <button 
              onClick={handleLogin}
        ...
        {/* Footer */}
        <div className="mt-auto flex justify-between items-center py-[8.347vw] max-md:flex-col-reverse max-md:items-start">
          <div className="flex gap-[0.278vw] items-center text-[0.833vw] uppercase">
            <span className="text-[rgba(255,255,255,0.45)] max-md:text-[3.2vw] max-md:mr-[7.167vw]">Picheni © 2024</span>
            <span className="text-[rgba(255,255,255,0.6)] max-md:text-[3.2vw] max-md:mr-[7.167vw]">terms</span>
            <span className="text-[rgba(255,255,255,0.6)] max-md:text-[3.2vw] max-md:mr-[7.167vw]">privacy</span>
            <span className="text-[rgba(255,255,255,0.6)] max-md:text-[3.2vw] max-md:mr-[7.167vw]">help</span>
          </div>
          <div className="flex gap-[0.208vw] max-md:mb-[8.533vw]">
            <div className="cursor-pointer max-md:mr-[1.389vw]">
              <img src="./images/icons/insta.svg" alt="/images/icons/telegram.svg" />
            </div>
            <div className="cursor-pointer">
              <img src="./images/icons/telegram.svg" alt="/images/icons/insta.svg" />
            </div>
          </div>
        </div>
      </div>
