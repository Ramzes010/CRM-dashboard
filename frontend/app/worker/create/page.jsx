...
export default function CreateWorkerPage() {
  ...
  return (
    ...
    {/* header mobile */}
    <svg width="36" height="36" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden max-md:block max-md:w-[10.417vw] max-md:ml-[3.267vw] max-md:mt-[3.2vw] max-md:w-[10.417vw] max-md:h-[10.417vw]">
